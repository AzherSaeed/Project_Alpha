...
const Founder = () => {
  return (
    <div className="flex max-w-[95%] lg:max-w-[1089px] mx-auto flex-col items-center justify-between space-y-6 lg:space-y-[12px] mb-16 lg:mb-[128px]">
      <div
        className={`font-bold text-2xl lg:text-[34px] leading-8 lg:leading-[46px] text-center text-zinc-700 ${plusJakartaSans.className}`}
      >
        Founders
      </div>
      <div className="flex flex-col">
        <div
          className={`max-w-full lg:max-w-[910px] font-normal text-sm lg:text-lg mb-8 lg:mb-[55px] leading-6 lg:leading-8 text-center text-slate-500 capitalize ${plusJakartaSans.className}`}
        >
      ...
      <div className="relative flex flex-col lg:flex-row gap-6 lg:gap-[74px] justify-center items-center">
        ...
        <div id="profile1" className="flex flex-row justify-between w-full lg:w-[218px] space-x-3">
          ...
          <div className="space-y-2 lg:space-y-4">
            <div className="w-[145px] space-y-1">
              <div className={`font-bold text-base lg:text-lg leading-6 lg:leading-[22px] text-blue-950 ${plusJakartaSans.className}`}>Pricillia Makalew</div>
              <div className={`font-normal text-xs lg:text-sm leading-[14px] text-slate-500 ${plusJakartaSans.className}`}>CEO, Cofounder</div>
            </div>
        ...
        <div className="hidden lg:block absolute top-0 bottom-0 left-1/2 transform -translate-x-1/2 border-l border-gray-300"></div>
