...
const Founder = () => {
  return (
    <div className="flex max-w-[1089px] mx-auto flex-col items-center justify-between space-y-[12px] mb-[128px]">
    <div
    ...
    <div className="flex flex-col">
      <div
        className={`max-w-[910px] font-normal text-base lg:text-lg mb-[55px] leading-8 text-center text-slate-500 capitalize ${plusJakartaSans.className}`}
      >
      ...
      <div className="relative flex gap-[74px] justify-center items-center  ">
<div id="profile1" className="flex flex-row justify-between w-[218px] space-x-3 ">
...
<div id="profile2" className="flex flex-row justify-between w-[218px] space-x-3">
<img className="flex size-[56px] left-0 top-0" src="/images/PhotoF.png" alt="" />
<div className="space-y-4">
  <div className="w-[145px] space-y-1">
    <div className={`font-bold text-lg leading-[22px] text-blue-950 ${plusJakartaSans.className}`}>Pricillia Makalew</div>
