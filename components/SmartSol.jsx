...
const SmartSol = () => {
  return (
    <div className="flex flex-col container h-auto space-y-10 lg:space-y-0 mt-32">
    <div className="max-w-[969px] mx-auto">
      ...
      <div
        className={`max-w-[733px] mx-auto font-normal text-base lg:text-lg leading-8 text-center text-slate-500 ${plusJakartaSans.className}`}
      >
    ...
    <div className="flex flex-col lg:flex-row w-auto h-auto justify-between items-center space-y-10 lg:space-y-0">
      <div>
        {" "}
